                    ...
                    {["memberId", "orderId", "orderValue"].map((field, idx) => (
                        <div key={idx} className="flex flex-col">
                            <label className="block text-sm font-medium text-gray-600 mb-1">
                                {field === "memberId" ? "Mã khách hàng" : field === "orderId" ? "Mã hóa đơn" : "Giá trị hóa đơn"}
                            </label>
                            <input
                                type="text"
                                name={field}
                            ...
                            />
                            {field === "orderValue" ? (<span className="text-green-800 text-[12px] font-bold capitalize pt-1">{speakNumber(addPointData.orderValue)}</span>) : ("")}
                            {field === "memberId" && (
